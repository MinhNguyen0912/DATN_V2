...
namespace DATN.Client.Areas.Admin.Controllers
{
    ...
    public class AttributesController : Controller
    {
        ...
        public async Task<IActionResult> Index(AttributesPaging request)
        {
            AttributesPaging Paging = new AttributesPaging();

            try
            {
                Paging = await _clientService.Post<AttributesPaging>($"{ApiPaths.AttributeEAV}/GetAttributePaging", request);
            ...
            //var requestUrl = $"{ApiPaths.AttributeEAV}/GetAll";
            //var listAtributes = await _clientService.Get<List<AttributeVM_EAV>>(requestUrl);
